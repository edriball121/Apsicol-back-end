...
const pro_precio = Joi.number();
const pro_estado = Joi.string().max(45);
const pro_cantidad = Joi.number();
const pro_terminos_y_condiciones = Joi.number();
const pro_foto = Joi.string().max(120);

//Regla para crear producto
const createProductSchema = Joi.object({
  pro_codigo: pro_codigo.required(),
