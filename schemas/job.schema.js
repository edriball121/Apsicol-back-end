...
const emp_terminos_y_condiciones = Joi.string().min(2).max(1000).regex(/^[a-zA-Z,.;:ñÑáéíóúÁÉÍÓÚ\s\-" ]+$/);
...
const createJobSchema = Joi.object({
  ...
  emp_terminos_y_condiciones: emp_terminos_y_condiciones.required(),
...
const updateJobSchema = Joi.object({
  ...
  emp_terminos_y_condiciones: emp_terminos_y_condiciones,
